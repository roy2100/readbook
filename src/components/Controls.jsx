...
function FileLabel({ onFileOpen, className, children }) {
    ...
    <footer className={`controls${readingMode ? ' controls-reading-mode' : ''}`}>
      ...
      <div className="controls-row controls-row-1">
        <div className="controls-nav">
          <Button variant="outline-secondary" size="sm" onClick={onPrev} disabled={isPrevDisabled} title="上一章">
          ...
          <Button variant="outline-secondary" size="sm" onClick={onNext} disabled={isNextDisabled} title="下一章">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
      ...
      <div className="controls-row controls-row-3">
        ...
        >
          ...
          <span className="reading-mode-btn-label">{readingMode ? '退出阅读' : '阅读模式'}</span>
        </Button>
      </div>
